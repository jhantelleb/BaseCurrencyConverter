...
struct CurrencyFlagAndSignsDictionary {
    ...
    var listOfAvailableCurrencies: [String: Any] { return self.getListOfAvailableCurrencies() }
    ...
    func createDictionaries() {
        ...
        let flagsAndSigns: [String:Any] =
            ["all" : ["currencyName" : "Lek", "iso" : "ALL", "flagImage" : "all.png", "signSymbol" : "Lek"],
    ...
    fileprivate  func getListOfAvailableCurrencies() -> [String: Any] {
        ...
        if let listOfAvailable = UserDefaults.standard.dictionary(forKey: "flagsAndSigns") {
            return (listOfAvailable)
        }
        
//
//            let dictionary = $0.value as? [String:String]
//            print(dictionary)
//            guard let name = dictionary["currencyName"] else { return [] }
//            allCurrencyNames.append(name)
        return [:]
        }
